...
using RoomVoiceControl.Droid.Services;
using RoomVoiceControl.Services;

[assembly: Xamarin.Forms.Dependency(typeof(SpeechToText_Droid))]
namespace RoomVoiceControl.Droid.Services
{
    public class SpeechToText_Droid : ISpeechToText
    {
        private readonly int VOICE = 10;
        private Activity _activity;
        public SpeechToText_Droid()
        {
